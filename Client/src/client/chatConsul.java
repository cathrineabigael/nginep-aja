...
public class chatConsul extends javax.swing.JFrame implements Runnable{

    /**
     * Creates new form chatConsul
     */
    Thread t;
    Socket clientSocket;
    ...
    String Input;
    String nama;
    public chatConsul(String m, Socket socketClient) {
        initComponents();
        this.nama = m;
        clientSocket = socketClient;
        setLocationRelativeTo(null);
//            Input = JOptionPane.showInputDialog("Isikan Nama");
//            chatFromServer = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
//           String userlogin = chatFromServer.readLine();
        if (t == null) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("House Consultation");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chatConsul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chatConsul().setVisible(true);
            }
        });
    }
